    ...
    return (
        <div className="w-full h-full">
            ...
            <div className="w-full px-4 md:px-40  py-10 relative">
                <img src="/images/se.jpeg" alt="about" className="w-full rounded-md  h-[90vh] object-cover" />

                <div className="md:w-2/3 w-full space-y-5 mt-7">
                    <h1 className="text-2xl md:text-3xl font-bold">Software Engineer Jobs</h1>
                    <p className="font-light text-justify">
                        The software engineering field is thriving, with opportunities available nationwide. From startups to established tech giants, skilled engineers are in high demand to develop innovative solutions.
                    </p>

                    <h1 className="text-2xl md:text-3xl font-bold">Key Full Stack Developer Skills</h1>
                    <p className="font-light">
                        Our expertise in placing top Software Engineers across the United States is unmatched.
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 w-full">
                        {[
                            ...
                            "Mastery of software design principles",
