...
const CloudEngineer = () => {
    ...
    return (
        ...
        <>
            {loading ? <Loader /> : (<div className='w-full h-full'>
                <div className='w-full h-full'>
                    ...
                    <div className="w-full px-4 md:px-20 my-10 md:my-20 relative">
                        <img src="/images/ce (1).jpeg" alt="Cloud Engineer" className='w-full h-[40vh] md:h-[90vh] object-cover rounded-md' />

                        {/* Main Content */}
                        <div className="md:w-2/3 space-y-5 mt-7 text-left">
                            <h1 className='text-2xl md:text-3xl font-bold'>Cloud Engineer Jobs</h1>
                            <p className='font-light'>
                                Cloud Engineers are in high demand as companies migrate to cloud infrastructures.
                                Opportunities are plentiful nationwide, from cloud-native startups to large enterprises.
                            </p>

                            <h1 className='text-2xl md:text-3xl font-bold'>Key Cloud Engineer Skills</h1>
                            <p className='font-light'>
                                Our expertise in placing top Cloud Engineers across the United States is unmatched.
                            ...
                            {/* Stats Box */}
                            <div className="bg-white shadow-md p-6 w-full sm:w-80 border-t-4 border-blue-700 mt-10 sm:absolute sm:bottom-110 sm:right-50 sm:translate-y-[20%]">
