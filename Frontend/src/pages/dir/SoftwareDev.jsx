  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="w-full px-4 md:px-40  py-10 relative">
        <img src="/images/sd.jpeg" alt="about" className="w-full h-[90vh] object-cover rounded-md" />

        <div className="md:w-2/3 w-full space-y-5 mt-7">
          <h1 className="text-2xl md:text-3xl font-bold">Software Developer Jobs
          </h1>
          ...
          <h1 className="text-2xl md:text-3xl font-bold">Key Software Developer Skills</h1>
