  ...
  return (
    <div className="w-full h-full mt-20">
      ...
      <div className="w-full px-4 md:px-40  py-10 relative">
        <img src="/images/se.jpeg" alt="about" className="w-full h-[90vh] object-cover rounded-md" />

        <div className="md:w-2/3 w-full space-y-5 mt-7">
          <h1 className="text-2xl md:text-3xl font-bold">Full Stack Developer Jobs</h1>
          <p className="font-light text-justify">
            The job market for Full Stack Developers is booming nationwide. From bustling tech hubs on the coasts to growing innovation centers in the Midwest and South, there are exciting opportunities for skilled developers all over the country.
          </p>

          <h1 className="text-2xl md:text-3xl font-bold">Key Full Stack Developer Skills</h1>
          <p className="font-light">
            Our expertise in placing top Full Stack Developers across the United States is unmatched. Companies are actively seeking candidates who possess:
          </p>
          ...
          <div className="bg-white shadow-md p-6 w-full md:w-80 border-t-4 border-blue-700 rounded-md mt-10 md:absolute md:top-130 md:right-50">
            <div className="space-y-4">
              ...
              <div className="flex justify-between">
                ...
                <span>$49 - $89 <span className="text-sm">/hr</span></span>
              </div>
              <hr />
              <div className="flex justify-between">
                <span className="font-semibold">Highest Vacancies In:</span>
                <span>New York, Austin</span>
              </div>
            </div>
          </div>
        </div>
